...
public class PointServiceImpl implements PointService {
    ...
    public double getTotalOfPointsPossibleNikoNiko(List<Survey> surveys, long sizeTeam){
        ...
        return (double) ( totalOfActivities / sizeTeam );
    ...
    private double getPointBy12TwelveStepsSurvey(Activity activity){
        ...
        if (!activity.getAnswer().isEmpty()) {
            return switch (activity.getAnswer()) {
                case ResponseQuestionsConstants.RESPONSE_OPTION_ONE -> 1d;
                case ResponseQuestionsConstants.RESPONSE_OPTION_TWO -> 2d;
                case ResponseQuestionsConstants.RESPONSE_OPTION_THREE -> 3d;
                case ResponseQuestionsConstants.RESPONSE_OPTION_FOUR -> 4d;
                case ResponseQuestionsConstants.RESPONSE_OPTION_FIVE -> 5d;
                default -> 0d;
            };
        }
        return 0d;
